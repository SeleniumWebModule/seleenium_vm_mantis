...
Vagrant.configure(VAGRANT_FILE_VERSION) do |config|
  ...
  config.vm.define :selenium_mantis do |selenium_mantis|
	  selenium_mantis.vm.network "private_network", ip: "192.168.70.102"
	  #selenium_mantis.vm.network "forwarded_port", guest:8081, host: 8081
  end
